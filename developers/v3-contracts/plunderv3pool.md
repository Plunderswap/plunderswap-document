...
_Prevents calling a function from anyone except the address returned by IPlunderV3Factory#owner()_
...
_The caller of this method receives a callback in the form of IPlunderV3SwapCallback#PlunderV3SwapCallback_
...
_The caller of this method receives a callback in the form of IPlunderV3FlashCallback#PlunderV3FlashCallback Can be used to donate underlying tokens pro-rata to currently in-range liquidity providers by calling with 0 amount{0,1} and sending the donation amount(s) from the callback_
